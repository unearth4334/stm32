/**
 * @file main.c
 * @brief STM32L053 composite CDC+HID demo.
 *
 * Same behaviour as the F4 variant:
 ...
 *
 * USB clock: HSI48 + CRS, configured inside usbd_conf_l0.c MspInit.
 *
 * Build with USE_USB_COMPOSITE=ON, STM32_USE_L0=ON.
 */
